...
```{r, echo=FALSE,layout='l-page', out.width="100%", fig.cap="The original data visualization"}
...
```{r, echo=FALSE,layout='l-page', out.width="100%", fig.cap="A sketch of the suggested visualizatons"}
...
14. Finally, set the axis range to be from 0 to 300 so that sizes of the bars are compararble across both visualizations.

<center>

![Making the bar charts of similar size scales](C:/totallyheen/blog/_posts/2021-01-26-dataviz-makeover-1/Dataprep_9.jpg){width=60%}
...
![Keeping colors consistent across visuals will make cross referencing intuitive](C:/totallyheen/blog/_posts/2021-01-26-dataviz-makeover-1/2Dataprep_7.jpg){width=70%}
...
15. Finally, set the axis range to be from 0 to 300 so that sizes of the bars are compararble across both visualizations.

<center>

![Making the bar charts of similar size scales](C:/totallyheen/blog/_posts/2021-01-26-dataviz-makeover-1/2Dataprep_8.jpg){width=70%}
...
3. Reduce font size of chart titles to *10* to give more screen space to the chart in order to convey information

<center>

![Initial Layout of the dashboard with reduced title font sizes](C:/totallyheen/blog/_posts/2021-01-26-dataviz-makeover-1/dashboard_1.jpg){width=90%}
...
![Removing a redundant legend](C:/totallyheen/blog/_posts/2021-01-26-dataviz-makeover-1/dashboard_2.jpg){width=40%}
...
Workforce participation for 25 to 54 year olds is the highest and consistently above 90%. These groups form the biggest part of the residential workforce and also participate the most. This is important for Singapore's economy as its biggest group of workers are consistently and actively participating in positive economic activity. This is also something to be concerned about, as this group of workers age, their workforce participation is likely to mirror that of the current older age groups. If this group of residents (the largest group) turn older and stop partcipating, it will have grave consequences for Singapore's economy and signals the need for rejuvenation.

<center>

![Workforce participation drops significantly after 65 years old.](C:/totallyheen/blog/_posts/2021-01-26-dataviz-makeover-1/insights_1.jpg){width=70%}

</center>

## 5.2 Workforce participation changes significantly from 65

The workforce participants in each age group usually account for the majority of resident workforce (i.e. >50% as seen by the orange arrows). This is true until the age group of 65-69 (as marked out by the blue arrows). From here on, the work force participation drops significantly. This is in line with what we can expect from Singapore's offcial retirement age which is currently set at 67 years old. With the retirement age expected to be raised till 70 years old in by 2030, the workforce participation picture is likely to change significantly from what we are saeeing now.

<center>

![The biggest group of workers participate actively in the workforce](C:/totallyheen/blog/_posts/2021-01-26-dataviz-makeover-1/insights_2.jpg){width=40%}
...
![Stagnating growth in young residential workforce and participation](C:/totallyheen/blog/_posts/2021-01-26-dataviz-makeover-1/insights_3.jpg){width=30%}

...
![Original Dataset in table 7](C:/totallyheen/blog/_posts/2021-01-26-dataviz-makeover-1/Dataprep_1.jpg)

</center>

1. Using the (TOTAL) sheet in table 7, select and preserve only the required data. i.e. Age groups, 2009 and 2019. Delete all other rows (including the total row) and columns (and blank columns). 
...
4. Save the excel file,create a new Tableau workbook and load dataset into Tableau. Ensure that the data is loaded correctly and the datatypes are correctly identifed by tableau.
...
5. Switch to Sheet 1 in Tableau
...
![Adding finishing touches and labels](C:/totallyheen/blog/_posts/2021-01-26-dataviz-makeover-1/Dataprep_7.jpg){width=100%}
...
Age-Sex Pyramid by Labour Force Participation as at June 2009 and June 2019
dfsdfds
1. dfsdfsd

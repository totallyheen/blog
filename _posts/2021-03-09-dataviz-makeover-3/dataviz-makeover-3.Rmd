...
```{r, fig.align="center",layout='l-page', echo=FALSE, fig.width=50, fig.height=100, fig.cap="The proposed data visualization with improvements)"}
knitr::include_graphics("proposed.png")
```
